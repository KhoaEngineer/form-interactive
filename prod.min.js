...
$('#design').on('change',function() {
	if($(this).val() === 'js-puns'){
		$('.puns').show();
		$('.lovejs').hide();
		$('#color').val($('option[value="cornflower"]').val());
	} else {
		$('.puns').hide();
		$('.lovejs').show();
		$('#color').val($('option[value="tomato"]').val());
	}
});
...
$('#act-jsframe').on('change',function() {
	if($(this).prop('checked')) {
		$('#act-express').prop('disabled', true);
		$('#act-express').parent().addClass('text-muted');
	} else {
		$('#act-express').prop('disabled', false);
		$('#act-express').parent().removeClass('text-muted');
	}
});
$('#act-express').on('change',function() {
	if($(this).prop('checked')) {
		$('#act-jsframe').prop('disabled', true);
		$('#act-jsframe').parent().addClass('text-muted');
	} else {
		$('#act-jsframe').prop('disabled', false);
		$('#act-jsframe').parent().removeClass('text-muted');
	}
});

$('#act-jslib').on('change',function() {
	if($(this).prop('checked')) {
		$('#act-nodejs').prop('disabled', true);
		$('#act-nodejs').parent().addClass('text-muted');
	} else {
		$('#act-nodejs').prop('disabled', false);
		$('#act-nodejs').parent().removeClass('text-muted');
	}
});

$('#act-nodejs').on('change',function() {
	if($(this).prop('checked')) {
		$('#act-jslib').prop('disabled', true);
		$('#act-jslib').parent().addClass('text-muted');
	} else {
		$('#act-jslib').prop('disabled', false);
		$('#act-jslib').parent().removeClass('text-muted');
	}
});
/***end activities*****/
